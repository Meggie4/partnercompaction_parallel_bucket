...
class Benchmark {
 ...
 public:
  ...
  void Run() {
    ...
    while (benchmarks != nullptr) {
      ...
      ///////uniform
      ////load 
      } else if(name == Slice("loaduniform100_15000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loaduniform100_15000k;
      } else if(name == Slice("loaduniform100_20000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loaduniform100_20000k;
      } else if(name == Slice("loaduniform100_1000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loaduniform100_1000k;
      } else if(name == Slice("loaduniform100_5000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        ...
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loaduniform100_25000k;
      } else if(name == Slice("loaduniform100_30000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loaduniform100_30000k;
      //////read
      } else if(name == Slice("readuniform100_15000k")) {
        method = &Benchmark::Readuniform100_15000k;
      } else if(name == Slice("readuniform100_20000k")) {
        method = &Benchmark::Readuniform100_20000k;
      } else if(name == Slice("readuniform100_1000k")) {
      ...
      ////load 
      ...
      } else if(name == Slice("loadzipfian100_300k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loadzipfian100_300k;
        ...
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loadzipfian100_5000k;
      } else if(name == Slice("loadzipfian100_10000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loadzipfian100_10000k;
      } else if(name == Slice("loadzipfian100_15000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loadzipfian100_15000k;
      } else if(name == Slice("loadzipfian100_20000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loadzipfian100_20000k;
      } else if(name == Slice("loadzipfian100_25000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Loadzipfian100_25000k;
      } else if(name == Slice("loadzipfian100_30000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
      ...
      //////read
      ...
      } else if(name == Slice("readzipfian100_300k")) {
        method = &Benchmark::Readzipfian100_300k;
        ...
        method = &Benchmark::Readzipfian100_10000k;
      } else if(name == Slice("readzipfian100_15000k")) {
        method = &Benchmark::Readzipfian100_15000k;
      } else if(name == Slice("readzipfian100_20000k")) {
        method = &Benchmark::Readzipfian100_20000k;
      } else if(name == Slice("readzipfian100_25000k")) {
      ...
      /////latest
        ...
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Customedlatest1k_100k;
      } else if(name == Slice("customedlatest1k_1000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Customedlatest1k_1000k;
      //////////hotspot
      ///////for 100K entries
      //write for 256B value 
      } else if(name == Slice("customed99hot256_100k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Customed99hot256_100k;
      } else if(name == Slice("customed80hot256_100k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Customed80hot256_100k;
      ...
      /////////for 1000K entries
      //write for 256B value 
      } else if(name == Slice("customed99hot256_1000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Customed99hot256_1000k;
      } else if(name == Slice("customed80hot256_1000k")) {
        entries_per_batch_ = 1000;
        fresh_db = true;
        method = &Benchmark::Customed80hot256_1000k;
      //////only write for 1KB value
 ...
 private:
  ...
  ////uniform
  //////////load 
  void Loaduniform100_15000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/load_1.5G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  void Loaduniform100_20000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/load_2G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  
  void Loaduniform100_1000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/load_100M.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  ...
  void Loaduniform100_5000k(ThreadState* thread){
  ...
  void Loaduniform100_30000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/load_3G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  ////read 
  void Readuniform100_15000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/read_1.5G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  void Readuniform100_20000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/read_2G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  
  void Readuniform100_1000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/read_100M.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  ...
  void Readuniform100_25000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/uniform/read_2.5G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  void Readuniform100_30000k(ThreadState* thread){
  ...
  void Loadzipfian100_300k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/load_30M.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  ...
  void Loadzipfian100_10000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/load_1G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  void Loadzipfian100_15000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/load_1.5G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  void Loadzipfian100_20000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/load_2G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  void Loadzipfian100_25000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/load_2.5G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  void Loadzipfian100_30000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/load_3G.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  ////read 
  ...
  void Readzipfian100_300k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/read_30M.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  ...
  void Readzipfian100_10000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/read_1G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  void Readzipfian100_15000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/read_1.5G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  void Readzipfian100_20000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/read_2G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  void Readzipfian100_25000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/read_2.5G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  void Readzipfian100_30000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/zipfian/read_3G.txt"; 
      CustomedWorkloadRead(thread, fname);
  }
  ///////////write
  ...
  //////latest
  void Customedlatest1k_100k(ThreadState* thread){
      std::string fname = "/mnt/workloads/latest/runwrite1k_100k.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  void Customedlatest1k_1000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/latest/runwrite1k_1000k.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  /////hotspot
  ////////for 100K entries 
  /////only write
  //for 256B 
  void Customed99hot256_100k(ThreadState* thread){
      std::string fname = "/mnt/workloads/hot1_99/runwrite256_100k.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
 
  void Customed80hot256_100k(ThreadState* thread){
      std::string fname = "/mnt/workloads/hot20_80/runwrite256_100k.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  ...
  /////only write
  //for 256B 
  void Customed99hot256_1000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/hot1_99/runwrite256_1000k.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
 
  void Customed80hot256_1000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/hot20_80/runwrite256_1000k.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  //for 1k
  void Customed99hot1k_1000k(ThreadState* thread){
      std::string fname = "/mnt/workloads/hot1_99/skewrunwrite1k_1000k.txt"; 
      CustomedWorkloadWrite(thread, fname);
  }
  ...
  void CustomedWorkloadWrite(ThreadState* thread, std::string fname) {
    ...
    fprintf(stderr, "write kv pair %d\n", num);
    thread->stats.AddBytes(bytes);
  }
  //////////////meggie
...
int main(){
    ...
    for(auto it = frequencies.begin(); it != frequencies.end(); it++){
        std::cout<<"key: "<<it->first<<", frequencies: "<<((it->second * 1.0)/sz * 100)<<"%"<<std::endl;
    }
    std::cout<<"sum entries: "<<sz<<", unique entries: "<<frequencies.size()<<std::endl;
    return 0;
}
*/
