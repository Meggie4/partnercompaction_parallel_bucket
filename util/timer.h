...
enum TimerStep {
	BEGIN,
    /////////////meggie
	PARALLEL_COMPACTION_MEMTABLE,
    COMPACT_MULTI_MEMTABLE,
...
public:
	...
	void init() {
		message[COMPACT_MULTI_MEMTABLE] = "COMPACT_MULTI_MEMTABLE";
        message[PARALLEL_COMPACTION_MEMTABLE] = "PARALLEL_COMPACTION_MEMTABLE";
